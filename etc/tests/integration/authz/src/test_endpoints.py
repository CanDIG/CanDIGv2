...
class TestEndpoints():
    ...
    def test_jibberish_authn(self):
        ...
        jibberish="ab123.something.that-doesn't-work"
        headers = {'Authorization': f'Bearer {jibberish}'}
