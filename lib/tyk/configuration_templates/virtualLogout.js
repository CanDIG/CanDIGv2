...
logoutHelper = {
  ...
  logoutUrl: function (spec, idToken) {
    ...
    url += spec.config_data.KEYCLOAK_AUTH_PREFIX + "/realms/" + spec.config_data.KEYCLOAK_REALM;
    url +=
  ...
  getSessionID: function (request, spec) {
    ...
    var refreshToken = sessionToken.split("=")[1].split("|")[0];
    var body = {
    ...
    var tokenRequest = {
      ...
      Resource:
        spec.config_data.KEYCLOAK_AUTH_PREFIX +"/realms/" +
