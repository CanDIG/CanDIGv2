...
python $PWD/lib/candig-ingest/candigv2-ingest/generate_test_data.py --commit 035ccbec70ddb9fb6b3daba44c88d82249388fe3 --prefix $CANDIG_SITE_LOCATION --tmp tmp/data/synthdata --delete
