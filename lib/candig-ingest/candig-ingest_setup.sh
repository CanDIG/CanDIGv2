...
python $PWD/lib/candig-ingest/candigv2-ingest/generate_test_data.py --commit 7f4b0ebe3aa768115218c726ebfc8e37482581e3 --prefix $CANDIG_SITE_LOCATION --tmp tmp/data/synthdata --delete
