...
docker exec $vault sh -c "vault write auth/jwt/config oidc_discovery_url=\"${TEMP_KEYCLOAK_PUBLIC_URL}/auth/realms/candig\" bound_issuer=\"${TEMP_KEYCLOAK_PUBLIC_URL}/auth/realms/candig\" default_role=\"researcher\""
