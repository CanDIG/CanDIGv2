...
You will need to modify the `.env` file to reflect your site's specific settings. Set CANDIG_SITE_LOCATION to the name of your site, such as UHN, BCGSC, or C3G. For federation settings, set the id, name, province, and province-code for `FEDERATION_SELF_SERVER` variable in the `.env`.
...
- The file size should not exceed 600x600 pixels. However, it is recommended to use a 34x34 pixel image
