...
2. Add the relevant volumes to the [htsget_app docker-compose file](https://github.com/CanDIG/CanDIGv2/blob/stable/lib/htsget/docker-compose.yml), [drs docker-compose file](https://github.com/CanDIG/CanDIGv2/blob/develop/lib/drs/docker-compose.yml) and [candig-ingest docker-compose file](https://github.com/CanDIG/CanDIGv2/blob/develop/lib/candig-ingest/docker-compose.yml)
...
Repeat the same process as above with the drs and candig-ingest docker compose files.
