...
:::tip
See [User roles](user-roles) for a full description of the available user roles in CanDIG.
:::

### Adding a site curator

See [User Roles](user-roles#how-to-assign-a-user-a-site-curator-role)
