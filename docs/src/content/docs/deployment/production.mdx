...
<Tabs>
  <TabItem label="Tabular `.env` changes">
| value in prod environment                                                                | What it does  |
|------------------------------------------------------------------------------------------|---------------|
| `CANDIG_DOMAIN=https://your.prod.domain`                                                       | Update to correct prod domain  |
| `CANDIG_AUTH_DOMAIN=https://your.prod.auth.domain`                                             | Update to correct prod auth domain  |
...
<TabItem label="diff style `.env` changes">
```sh title=".env" del={1,3,5,7,} ins={2,4,6,8}
...
CANDIG_SITE_LOCATION=LOCAL
CANDIG_SITE_LOCATION=your-site-location # BCGSC, UHN, C3G, etc.
CANDIG_DEBUG_MODE=1
CANDIG_DEBUG_MODE=0
```
</TabItem>
