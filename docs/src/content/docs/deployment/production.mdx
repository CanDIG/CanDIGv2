...
## Configurations for Genomic Ingest

To allow genomic ingest there are some extra configuration steps required. Please see [Configure connection to Genomic Data source/s](https://candig.github.io/CanDIGv2/ingest/prepare-genomic/#a-configure-connection-to-genomic-data-sources) for information on how to configure for NFS or s3 type file linkages.
