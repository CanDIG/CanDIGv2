...
Confirm your installation with the automatic integration tests:
...
[ingesting data](../guides/ingest) as well as [Interacting with the stack using Make](interact-with-the-stack)
and if you are a developer: [how to modify code and test changes](../technical/docker-and-submodules) in
