...
Detailed information about what each role means can be found on the [Roles overview](roles-overview) page. This page walks through how to assign, approve and reject various user roles.
...
## Change the site admin <Badge text="Site admin" variant="caution" />
