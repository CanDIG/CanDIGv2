...
It is assumed that before a site admin can grant access to an external user that a Data Access Committee (DAC) process has been undertaken outside of CanDIG. The result of this process would then be communicated to the site admin so that they can use these details to grant the user access to the appropriate datasets for the specified amount of time. Once granted access, a user will have full access to all donor level data, including both clinical and genomic data. 
